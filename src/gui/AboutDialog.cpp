...
AboutDialog::AboutDialog(QWidget* parent)
    ...
    QLabel* content = new QLabel("<html>"
                                 ...
                                 "<p>"
                                 "Meowchestra<br>"
                                 "GitHub: <a href=\"https://github.com/Meowchestra\">github.com/Meowchestra</a><br>"
                                 "</p>"
                                 "<h3>Based on MidiEditor by</h3>"
                                 "<p>"
                                 "Markus Schwenk - https://github.com/markusschwenk<br>"
                                 "Website: <a href=\"https://midieditor.org/\">www.midieditor.org</a> | <a href=\"http://www.markus-schwenk.de\">www.markus-schwenk.de</a><br>"
                                 "Email: support@midieditor.org | kontakt@markus-schwenk.de<br>"
                                 "</p>"
                                 "<h3>Contributors</h3>"
                                 + contributors +
                                 "<h3>Credits</h3>"
