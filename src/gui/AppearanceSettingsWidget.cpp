...
AppearanceSettingsWidget::AppearanceSettingsWidget(QWidget *parent)
    ...
    strip->addItems({tr("Highlight by Octaves"), tr("Highlight by Scale"), tr("Highlight by Alternating"), tr("Rainbow Octaves"), tr("Rainbow Octaves Scale"), tr("Rainbow Octaves Alternating")});
